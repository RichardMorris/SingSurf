...
public class GeneralizedIntersection_IP extends PjProject_IP  implements ActionListener {
	private static final long serialVersionUID = -6967264854566009554L;

	/** Reference to main PjPsurfJepNew class */
	GeneralizedIntersection parent;
...
//		System.out.println("IP setParent");
		...
		parent = (GeneralizedIntersection)par;
		parent.m_IP = this;
...
//				p1.addSubTitle("Definition");
		...
		p1.addSubTitle("Ingredient:");
		p1.add(parent.ch_ingredient);
